...
Use `if` to test whether object `mtcars.tsv` exists and run `head` if it does
exist.
...
Use `replicate` to quantify how frequent it is to draw the same number twice
where the pool of numbers consists of 0 to 9.
