...
You could also use the `princomp()` package.
...
packages.
Make yourself familiar with the [DESeq2 page on Bioconductor](https://bioconductor.org/packages/release/bioc/html/DESeq2.html).
...
Gene sets of Reactome pathways can be downloaded [here](https://ziemann-lab.net/public/bioinfo_workshop/ReactomePathways_2025-10-15.gmt).
They are loaded in as list of vectors.
...
Below is an example workflow using
...
Then use Google Scholar, BibGuru or CiteDrive to get the .bib format of your articles.
