...
....* report.pg_matrix.tsv intensities on the peptide level (9390 proteins detected)

....* report.pr_matrix.tsv Intentities on the protein level (121010 peptides detected)

## Short guide to downstream analysis

Essential steps:

* Read report.pg_matrix.tsv into R, select the numerical data and decide on the row name
schema.
