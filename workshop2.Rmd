...
We won't write up a data management plan in today's session, but it should be something you
should address to remain in compliance with Burnet and funder guidelines.
...
Could you pass the [10 year challenge](https://www.nature.com/articles/d41586-020-02462-7)?
...
bioinformatician
([link](https://medium.com/data-science/scientific-data-analysis-pipelines-and-reproducibility-75ff9df5b4c5)).
...
Storing data and conducting bioinformatics work is recommended on dedicated on premises hardware.
...
We will draft a data management plan later, but for now let's focus on the practical aspects of
data handling on Linux systems.

<img src="https://m.media-amazon.com/images/I/71rDs-OMjBL._SL1100_.jpg" alt="Data Management for Researchers, By Kristin Briney." width="300" height="400" />
Further reading: Data Management for Researchers, By Kristin Briney.
...
Practice by downloading two fastq files to a new working directory:

```
wget https://ziemann-lab.net/public/bioinfo_workshop/100507_R1.fq.gz
wget https://ziemann-lab.net/public/bioinfo_workshop/100507_R2.fq.gz
```

You could also be given a physical hard drive, then you need to transfer the data from your PC to
your server.
The two most important approaches to data transfer are `scp` and `rsync`.
...
We can use the `md5sum` command to obtain a checksum.
...
```
wget https://ziemann-lab.net/public/bioinfo_workshop/checksums.md5
...
A good README for a data science research project should include these key elements:

**Project Title and Description**

* Clear, descriptive title
* Brief overview of the research question or problem
* Context about why this work matters

**Getting Started**

* Prerequisites and dependencies (Python version, required packages)
* Installation instructions
* How to set up the environment (conda, venv, Docker, etc.)
...
* License/usage restrictions if applicable

**Project Structure**

* Directory organization
* Description of key files and folders
* Where to find notebooks, scripts, models, results

**Usage/Reproducibility**

* Step-by-step instructions to reproduce results
* How to run the code (scripts, notebooks, pipelines)
* Expected outputs
* Computational requirements (GPU, memory, runtime estimates)

**Methodology**

* High-level overview of approach
* Key algorithms or models used
* Links to relevant papers or documentation

**Results**

* Summary of findings
* Links to detailed results or reports

**Authors and Acknowledgments**

* Contributors
* Citations for papers, datasets, or code you built upon
* Funding sources if applicable

**License**

Software license (MIT, Apache, GPL, etc.)
Separate data license if needed

**Optional but Valuable**

* Badges (build status, DOI, license)
* Troubleshooting section
* Contributing guidelines / contact info

The goal is to make your project understandable and reproducible for
...
To mitigate this, consider making files immutable using the `chattr` command.
...
and able to be accessed by the institution already.
...
<img src="images/projectpath.png" alt="Itai Yanai: false directions are common in research" width="450" height="300" />
...
researchers send each other scripts and code over email or some other medium.
...
<img src="images/dvcs.png" alt="Distributed version control. (A) Each author has a copy of the repository where their contributions are committed before being pushed to the main central repository. (B) An example hypothetical git workflow history for a research project involving a team of three authors. Circles represent code commits. Path divergences create separate branches for independent development. Horizontal paths indicate code changes for a particular branch. Path convergences indicate where branch specific differences are incorporated into the main branch." width="500" height="350"/>
...
If you already have an ed25519 key, then use a different unique name.
...
## Publishing code supporting your project
